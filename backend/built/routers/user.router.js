        ...
        switch (_c.label) {
            ...
            case 3:
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("username or password not valid");
                }
                return [2 /*return*/];
        }
    });
...
router.post("/register", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, user, encryptpassword, newUser, dbUser;
...
var genarateTokenResponse = function (user) {
